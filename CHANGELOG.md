...
- Added Edge Multi-Site-Origin for Delivery Services which go directly to the origin (HTTP_LIVE, DNS_LIVE, HTTP_NO_CACHE). For Edge MSO, the Origins must be in the same Cachegroup as the Edge. See the documentation for more details.
