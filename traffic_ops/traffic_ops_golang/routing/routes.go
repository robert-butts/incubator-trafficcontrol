...
func Routes(d ServerData) ([]Route, []RawRoute, http.Handler, error) {
	...
	routes := []Route{
		...
		////DeliveryServices
		{1.4, http.MethodGet, `deliveryservices/?(\.json)?$`, api.ReadHandler(deliveryservice.NewTODeliveryService(1.4)), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.3, http.MethodGet, `deliveryservices/?(\.json)?$`, api.ReadHandler(deliveryservice.NewTODeliveryService(1.3)), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.2, http.MethodGet, `deliveryservices/?(\.json)?$`, api.ReadHandler(deliveryservice.NewTODeliveryService(1.2)), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.1, http.MethodGet, `deliveryservices/?(\.json)?$`, api.ReadHandler(deliveryservice.NewTODeliveryService(1.1)), auth.PrivLevelReadOnly, Authenticated, nil},

		{1.4, http.MethodGet, `deliveryservices/{id}/?(\.json)?$`, api.ReadHandler(deliveryservice.NewTODeliveryService(1.4)), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.3, http.MethodGet, `deliveryservices/{id}/?(\.json)?$`, api.ReadHandler(deliveryservice.NewTODeliveryService(1.3)), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.2, http.MethodGet, `deliveryservices/{id}/?(\.json)?$`, api.ReadHandler(deliveryservice.NewTODeliveryService(1.2)), auth.PrivLevelReadOnly, Authenticated, nil},
		{1.1, http.MethodGet, `deliveryservices/{id}/?(\.json)?$`, api.ReadHandler(deliveryservice.NewTODeliveryService(1.1)), auth.PrivLevelReadOnly, Authenticated, nil},

		{1.1, http.MethodPost, `deliveryservices/?(\.json)?$`, deliveryservice.Create, auth.PrivLevelOperations, Authenticated, nil},

		{1.1, http.MethodPut, `deliveryservices/{id}/?(\.json)?$`, deliveryservice.Update, auth.PrivLevelOperations, Authenticated, nil},

		{1.1, http.MethodDelete, `deliveryservices/{id}/?(\.json)?$`, deliveryservice.Delete, auth.PrivLevelOperations, Authenticated, nil},
