...
func RemoveDeliveryServiceURIKeysHandler(w http.ResponseWriter, r *http.Request) {
	...
	api.CreateChangeLogRawTx(api.ApiChange, "DS: "+xmlID+", ID: "+strconv.Itoa(dsID)+", ACTION: Removed URI signing keys", inf.User, inf.Tx.Tx, r)
...
func SaveDeliveryServiceURIKeysHandler(w http.ResponseWriter, r *http.Request) {
	...
	api.CreateChangeLogRawTx(api.ApiChange, "DS: "+xmlID+", ID: "+strconv.Itoa(dsID)+", ACTION: Stored URI signing keys to a delivery service", inf.User, inf.Tx.Tx, r)
