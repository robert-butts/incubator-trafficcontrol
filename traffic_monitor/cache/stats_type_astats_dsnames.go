...
func astatsdsnamesProcessStat(server tc.CacheName, stats map[tc.DeliveryServiceName]dsdata.CacheDSStats, toData todata.TOData, stat string, value interface{}) (map[tc.DeliveryServiceName]dsdata.CacheDSStats, error) {
...
func astatsdsnamesProcessStatPlugin(server tc.CacheName, stats map[tc.DeliveryServiceName]dsdata.CacheDSStats, toData todata.TOData, stat string, statParts []string, value interface{}) (map[tc.DeliveryServiceName]dsdata.CacheDSStats, error) {
	if len(statParts) < 1 {
...
func astatsdsnamesProcessStatPluginRemapStats(server tc.CacheName, stats map[tc.DeliveryServiceName]dsdata.CacheDSStats, toData todata.TOData, stat string, statParts []string, value interface{}) (map[tc.DeliveryServiceName]dsdata.CacheDSStats, error) {
	if len(statParts) < 3 {
...
func astatsdstypesAddCacheStat(stat *dsdata.CacheDSStats, name string, ival interface{}) error {
